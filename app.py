...
st.markdown("### Random Forest (rf_170) — Crop Selection from Soil Parameters")
...
if st.button("🌾 Get Crop Recommendation", type="primary", use_container_width=True):
	...
	try:
		rf_model = joblib.load("rf_170.pkl")
...
<div style='text-align: center; color: gray;'>
	<small>Model: rf_170.pkl | Features: N, P, K, pH, EC, S, Cu, Fe, Mn, Zn, B</small>
</div>
""",
